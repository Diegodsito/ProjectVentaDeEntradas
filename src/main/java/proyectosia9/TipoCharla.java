...
public class TipoCharla extends Evento{
     private final int duracion; // Atributo para la duración

    public TipoCharla(String nombre, String tipo, String ubicacion, String fecha, int capacidadTotal, int entradasDisponibles, String topico, int id) {
        super(nombre, tipo, ubicacion, fecha, capacidadTotal, entradasDisponibles, topico, id);
        this.duracion = 35; // Inicializa la duración con el valor fijo
    }
